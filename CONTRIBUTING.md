...
* 1パラグラフ単位で翻訳する
* ただし、rustのコードブロック(バッククォート3つで始まる別行立てのもの)中のコメントについては `#`を用いて英文のコメントを含むコードをコメントアウトし、直下にコメントを翻訳したものを書く。(See https://github.com/rust-lang-ja/the-rust-programming-language-ja/issues/13)
